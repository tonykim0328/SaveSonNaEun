...
OFILES = background.o banana.o egg.o enemy.o gameover.o heart.o introduction.o player.o poop.o rock.o title.o win.o main.o mylib.o 

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = background.h banana.h egg.h enemy.h gameover.h heart.h introduction.h player.h poop.h rock.h title.h win.h main.h mylib.h
